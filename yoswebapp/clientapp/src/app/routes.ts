...
import { ComponentAccountManagement} from './pages/component-account-management/component-account-management'
...
import { ModifyPwComponent } from './pages/modify-pw/component-modify-pw';
import { AuthGaurdService3 } from './service/auth-guard.service3';
export const MATERIAL_DOCS_ROUTES: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'settings/modify', component: ModifyComponent, canActivate:[AuthGaurdService2]},
      { path: 'settings/modifypw', component: ModifyPwComponent, canActivate:[AuthGaurdService2]},
      { path: 'settings/register', component: RegisterComponent, canActivate:[AuthGaurdService3]},
      { path: 'settings/management', component: ComponentAccountManagement, canActivate:[AuthGaurdService3]},
      
      { path: '**',  redirectTo: '/orderinq', pathMatch: 'full'  }
    ]
  },
